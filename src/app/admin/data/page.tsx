...
import { ChevronRight, GraduationCap, BookOpen, Users, UserCheck, BarChart3, Award, Calendar, CalendarOff } from 'lucide-react';
...
const items = [
  ...
  { icon: UserCheck, label: 'Siswa', desc: 'Data siswa', path: '/admin/data/siswa' },
